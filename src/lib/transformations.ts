 ...
 * @returns {String}
 */
function sanitizePhone(phone: string | number): string {
...
function formatAddress(record: $Address): string {
 ...
 * @return {object}
 */
function toSnakeCase(payload: Object | Array<Object>): Object {
 ...
 * @return {object}
 */
function toSnakeCaseCached(payload: Object | Array<Object>): Object {
  if (Array.isArray(payload)) {
    return _.map(payload, (item) => {
      return _.mapKeys(item, (value, key) => {
 ...
 * @return {object}
 */
function toCamelCase(payload: Object | Array<Object>): Object {
  if (Array.isArray(payload)) {
    return _.map(payload, (item) => {
      return _.mapKeys(item, (value, key) => {
 ...
 * @return {object}
 */
function toCamelCaseCached(payload: Object | Array<Object>): Object {
  if (Array.isArray(payload)) {
    return _.map(payload, (item) => {
      return _.mapKeys(item, (value, key) => {
