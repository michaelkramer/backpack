...
import { toSnakeCase } from "./transformations";
 ...
 */
function update(knex: Knex, tableName: string, filters: any, payload: any) {
 ...
 */
function updateOne(knex: Knex, tableName: string, filters: any, payload: any) {
